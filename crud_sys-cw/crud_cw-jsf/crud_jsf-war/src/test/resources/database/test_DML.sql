...
insert into pessoa(nome, cpf, nascimento) values ('Antonio Ferreira Silva', '40162439717', DATE '1983-04-10');
insert into pessoa(nome, cpf, nascimento) values ('Maria Antonieta de Almeida', '90763518646', DATE '1984-07-06');
insert into pessoa(nome, cpf, nascimento) values ('Fernando José Alves', '37678869282', DATE '1986-02-21');
insert into pessoa(nome, cpf, nascimento) values ('Francisco Oliveira', '27855291202', DATE '1991-06-21');
insert into pessoa(nome, cpf, nascimento) values ('Xavier da Silva Gomes', '80565450778', DATE '1981-06-02');
insert into pessoa(nome, cpf, nascimento) values ('Bruno Mariano Alves', '51245121642', DATE '1950-12-10');
insert into pessoa(nome, cpf, nascimento) values ('Carlos Henrique de Oliveira', '24531410742', DATE '2012-08-18');
insert into pessoa(nome, cpf, nascimento) values ('Davi Morais', '24756267122', DATE '1978-04-30');
insert into pessoa(nome, cpf, nascimento) values ('Ana Aparecida Alves', '23376534128', DATE '1988-01-16');
insert into pessoa(nome, cpf, nascimento) values ('Eugenio Alves Silva', '10552514640', DATE '1960-12-02');
insert into pessoa(nome, cpf, nascimento) values ('Fernando Antonio de Oliveira', '71788975383', DATE '2006-12-13');
insert into pessoa(nome, cpf, nascimento) values ('Carlos Alberto Silva', '86427122444', DATE '1980-11-25');
